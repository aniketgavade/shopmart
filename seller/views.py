...
def dashboard(request):
    ...
    # Prepare a dictionary to hold products under each category
    category_products = {}
    ...
    # Add category_products to the context
...
def add_category(request):
   data={}
   categories=Category.objects.filter(seller_id=request.user)
